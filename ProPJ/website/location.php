				...
				$(document).ready(
					...
					<div id="map">
							<div class="google-maps">
								<iframe id="frame_location" width="800" height="500" frameborder="0" style="left-float"  src="https://www.google.com/maps/embed/v1/place?q=FOntys%20eindhoven%20r1&key=AIzaSyCLmBgDgTupb2ahAHt70G1UwoAV7IVbmnM"></iframe>
							</div>
					</div>
		</div>
